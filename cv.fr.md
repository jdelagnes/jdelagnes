...
- **Langages & Frameworks** : Java 21, Spring Boot, Maven, Gherkin, Cucumber, SQL, Hibernate, JUnit, Mockito, bash
...
- **Cloud** : Kubernetes, SGCIB private cloud (Linux VM "on premise")
...
- **En cours**: [Kubernetes for the Absolute Beginners](https://www.udemy.com/course/learn-kubernetes/) - _Uemy_
